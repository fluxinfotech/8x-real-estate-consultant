...
export function WhatsAppFab({ whatsappDigits, message = 'Hello 8x Real Estate, I would like to discuss a property.' }: WhatsAppFabProps) {
  ...
  return (
    <Tooltip title="WhatsApp concierge" placement="left">
      <Zoom in>
        <Box
          sx={{
        ...
        >
          <Fab
            ...
            sx={{
              ...
              boxShadow: (t) => `0 18px 50px ${alpha(t.palette.primary.main, 0.45)}`,
              transition: 'transform 0.35s ease, box-shadow 0.35s ease',
              '&:hover': {
                transform: 'translateY(-3px) scale(1.04)',
                boxShadow: (t) => `0 22px 60px ${alpha(t.palette.primary.main, 0.55)}`,
              },
            }}
          >
            <WhatsAppIcon />
